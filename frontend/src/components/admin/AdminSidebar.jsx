        ...
        >
          <div
            style={{
              ...
              placeItems: 'center',
              borderRadius: 11,
              background: `linear-gradient(135deg, ${T.bronzeLight}, ${T.bronze})`,
              color: T.slate,
            }}
          >
          ...
          return (
            <button
              ...
              style={{
                ...
                gap: 11,
                borderRadius: 9,
                color: active ? T.bronzeLight : 'rgba(255,255,255,.57)',
                background: active ? 'rgba(168,138,100,.18)' : 'transparent',
                boxShadow: active ? 'inset 2px 0 0 #A88A64' : 'none',
                transition: 'background .18s ease',
              }}
            >
              <Icon size={17} strokeWidth={active ? 2.35 : 1.85} />
              <span
                style={{
      ...
      >
        ...
        {onToggle && (
          ...
          >
            ...
            />
            <span
              style={{ display: collapsed ? 'none' : 'block', fontSize: 11 }}
            >
              Collapse sidebar
            </span>
          </button>
      ...
      <>
        ...
        <aside
          style={{
            ...
            maxWidth: '85vw',
            background: T.slate,
            boxShadow: '18px 0 48px rgba(9,20,38,.28)',
          }}
        >
  ...
  return (
    ...
    >
      <SidebarContent
        ...
        onToggle={isTablet ? undefined : onToggle}
      />
    </aside>
  );
};
